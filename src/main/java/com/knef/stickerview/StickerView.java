...
public abstract class StickerView extends FrameLayout {
    ...
    private final static int CONTROLLER_VISIBILITY_TIME = 2000;
    ...
    public void shouldHideController(boolean status) {
        this.isHideable = status;
    }

    private void controlFrameVisibility(final boolean visible) {
        if (visible) {
            if (handler != null) {
            ...
            handler.postDelayed(runnable, CONTROLLER_VISIBILITY_TIME);
        }
    }
